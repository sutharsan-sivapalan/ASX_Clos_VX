...
#### Setup Instructions
  ...
  4. If you use git, clone this repo with the command ```https://github.com/sutharsan-sivapalan/ASX_Clos_VX.git```.  Otherwise, download the archive [here](https://github.com/sutharsan-sivapalan/ASX_Clos_VX/archive/master.zip).
...
![Topology](./ASX_CLos_VX-Topology.png)
